...
La maîtrise des frameworks frontend modernes est au cœur de mon métier de développeur fullstack. Plutôt que de me spécialiser sur un seul outil, j'ai développé une expertise transversale qui me permet de m'adapter aux besoins de chaque projet : React pour sa flexibilité et son écosystème, Angular pour les applications d'entreprise structurées, Svelte pour ses performances exceptionnelles, et Vue pour sa courbe d'apprentissage progressive.

Cette polyvalence n'est pas superficielle : sur chaque framework, je maîtrise les patterns avancés (state management, routing, SSR/SSG) et je comprends les compromis architecturaux qui guident le choix d'un outil plutôt qu'un autre.

## Mes éléments de preuve

### React 19 sur AppStandard (216k lignes)

Mon projet personnel **AppStandard** est entièrement développé en React 19 avec une architecture moderne : Server Components, hooks personnalisés, et un design system partagé entre trois applications (Calendar, Tasks, Contacts). Cette expérience sur un projet de grande envergure démontre ma capacité à structurer et maintenir une base de code React conséquente.

### Migration Angular 14 → Svelte 5 (Syren et Luce)

Chez BH Technologies, j'ai participé activement à la migration de Syren V4 et Luce V4 d'Angular 14 vers SvelteKit 2 avec Svelte 5. Cette migration impliquait de repenser les patterns (RxJS vers stores Svelte, services vers modules), tout en conservant les fonctionnalités existantes. Le résultat a été une amélioration significative des performances et de l'expérience développeur.

### Optimisation Angular et accessibilité (Syren V3)

Sur Syren V3, j'ai optimisé la carte temps-réel qui était lente avec de gros volumes de conteneurs. J'ai refactorisé le composant avec lazy loading, virtualisation des marqueurs et optimisation de la change detection Angular. J'ai également ajouté les attributs ARIA appropriés pour l'accessibilité. Résultat : amélioration notable du temps de rendu et conformité WCAG 2.1 AA atteinte.
